        ...
        <div
            ...
            <div class="card w-96 bg-base-100 shadow-xl">
                ...
                <div class="card-body">
                    ...
                    <nuxt-link to="/article/postone">
                        <p>عسل وحشی چیست ؟</p>
                    </nuxt-link>

                    <p>
                        عسل وحشی چیست ؟زنبور عسل وحشی ، زنبور نژاد ریز ، تنها گونه نژاد زنبور وحشی است که در ایران زندگی
                        می کند و اغلب در استان های جنوبی کشور زندگی می کند . رنگ این عسل بیشتر بستگی به شهد مورد استفاده
                        قرار گرفته توسط...
                    </p>
                    <div class="card-actions flex justify-between">
                        <div class="flex">
                            <img src="/img/user.png" alt="">
                            <div class="mr-3 mt-1">گل نوش</div>
                        </div>
                        <div>18 آبان 1400</div>
                    </div>
                </div>
            </div>
            <div class="card w-96 bg-base-100 shadow-xl">
